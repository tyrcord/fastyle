...
class FastCalculatorResultsOverlay extends StatelessWidget {
  final FastPaletteScheme? palette;
  final Widget? content;

  const FastCalculatorResultsOverlay({
    super.key,
    this.palette,
    this.content,
  });
  ...
  Widget build(BuildContext context) {
    return FastAlertDialog(
      titleText: CalculatorLocaleKeys.calculator_title_results.tr(),
